                ...
                <div className="relative flex flex-col items-start justify-start">
                    ...
                    <div className="absolute flex top-full left-0 bg-[#E9F2FF] flex-col justify-start items-start gap-6 px-4 pb-6 pt-4 rounded-2xl rounded-l-[0] shadow-lg
                        ...
                        {navlinkProps.dropdownItem1 && (
                            <Link href={`${navlinkProps.dropdownItem1}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
                        ...
                        {navlinkProps.dropdownItem2 && (
                            <Link href={`${navlinkProps.dropdownItem2}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
                        ...
                        {navlinkProps.dropdownItem3 && (
                            <Link href={`${navlinkProps.dropdownItem3}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
                        ...
                        {navlinkProps.dropdownItem4 && (
                            <Link href={`${navlinkProps.dropdownItem4}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
                        ...
                        {navlinkProps.dropdownItem5 && (
                            <Link href={`${navlinkProps.dropdownItem5}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
                        ...
                        {navlinkProps.dropdownItem6 && (
                            <Link href={`${navlinkProps.dropdownItem6}`} className="flex flex-row justify-start items-center gap-2 transition-all duration-500 hover:scale-105">
