...
function NavLinkLight(navlinkProps: navLinkProps) {
    return (
        <div className="hidden lg:flex relative group">
            {!navlinkProps.dropdown && (
                <Link
                    href={`${navlinkProps.to}`}
                    className="font-poppins font-medium text-base text-white p-3"
                >
                    {navlinkProps.name}
                </Link>
            )}
            {navlinkProps.dropdown && (
                <div className="relative flex flex-col items-start justify-start">
                    <div className="flex flex-row justify-start items-center gap-1 cursor-pointer p-3 rounded-lg rounded-b-[0]
                        ...
                        <p className="font-poppins font-medium text-base text-white group-hover:text-primaryBlue transition-all duration-300">
                            {navlinkProps.name}
                        </p>
