...
import NavLinkWhite from "@/components/navbar/NavLinkWhite";

interface navbarProps{
    bgColor: string
}

function NavbarDark(navProps: navbarProps) {
    ...
    return (
        <nav className={`${isScrolled ? 'bg-[#050B20] lg:bg-[#050B20] bg-opacity-100 lg:bg-opacity-10 backdrop-blur-md' : `bg-[${navProps.bgColor}]`} fixed z-[999] top-0 w-full h-auto py-4 px-[3%] lg:px-[5%] flex flex-row justify-between items-center transition-all duration-500`}>
            <Image src={logo} alt="Logo image." width="150"/>
            <div className={'flex flex-row justify-start items-center gap-6'}>
                <NavLinkWhite dropdown={true} name={'Home'}
                ...
                />
                <NavLinkWhite dropdown={true} name={'Brands'}
                ...
                />
                <NavLinkWhite dropdown={true} name={'Types'}
                ...
                />
                <NavLinkWhite dropdown={false} to={'/cars'} name={'All Cars'}/>
                <NavLinkWhite dropdown={false} to={'/about'} name={'About'}/>
                <NavLinkWhite dropdown={false} to={'/contact'} name={'Contact'}/>
                <Link href={'sign-in'}
