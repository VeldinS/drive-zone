...
function ButtonBlue(buttonProps: ButtonProps) {
    return (
        <Link href={buttonProps.link} className="group flex flex-row justify-center items-center px-6 py-3 sm:py-4 gap-4 rounded-xl bg-[#405FF2] border hover:scale-105 shadow-sm hover:shadow-xl border-[#405FF2]  transition-all duration-500">
