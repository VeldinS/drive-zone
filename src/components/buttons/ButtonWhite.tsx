...
function ButtonWhite(buttonProps: ButtonProps) {
    return (
        <Link href={buttonProps.link} className="group flex flex-row justify-center items-center px-6 py-3 sm:py-4 gap-4 rounded-xl bg-white border hover:scale-105 shadow-sm hover:shadow-xl border-black transition-all duration-500">
